...
public class AnyadirMonitorGerenteCorrecto {
	    ...
	    public void add_monitor() throws Throwable {
	    	...
	    	webDriver.findElement(By.id("correo")).sendKeys("correo@CUCUMBER.com");
	    	webDriver.findElement(By.id("telefono")).sendKeys("888555596");
	    	...
	    	webDriver.findElement(By.id("especialidad")).sendKeys("Motor");
